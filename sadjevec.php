...
<div class="container" >
	...
	<div class="row">
		...
		<div class="header-logo" style="background-color: #f0fff0; width:100%">
			<a href="index.php"><img src="logo.png"newline character alt="Logo" newline character width="150px" height="90px"/></a>

			<div class="login">
			<div class="dropdown">
			  <button class="dropbtn" style="padding: 4px; font-size: 14px;; background-color:green">prijavite se</button>
			  <div id="myDropdown" class="dropdown-content" >
				...
				<a href="member.php" class="dropbtn" style="padding: 4px; font-size: 14px;; background-color:blue" > obišči svoj profil</a>
			</div>
			</div>
...
<div class="main" id="mainContent"  >
	    ...
	    <div id="floated" style="float:left;">
	         <img id="imgsadjevec" src="slike/sadjevec1l.jpg" style="height:1000px;max-width:700px;width: expression(this.width > 700 ? 700: true);" />
	    </div>
