            ...
            <div class="login">
                <div class="dropdown">
                    <button class="dropbtn" id="loginButton"
                            style="padding: 10px; font-size: 14px;; background-color:green">prijavite se
                    </button>
                ...
                <a href="member.php" class="dropbtn" id="profileButton"
                   style="padding: 10px; font-size: 14px;; background-color:blue"> obišči svoj profil</a>

                <a href="cart.html" class="dropbtn" id="cart"
                   style="padding: 10px; font-size: 14px;; background-color:green"> SHOPPING CART</a>
            </div>
        ...
        <div class="zamik">
            ...
            <div>
                ...
                <div id="parent" style="width:100%;">
                    <div class="narrow"
                         style="background-color:brown;margin:0;min-width:500px;width:30%;display: inline-flex;">
                        <div style="height:200px;margin:0;">
                            <li><img src="slike/smallsadjevec1l.jpg" height="200px"/>Liter</li>
                            <button class="dropbtn" style="margin-left:10px"><a href="zgodovina.php" class="dropbtn">Dodaj
                                    1 litra</a></button>
                        </div>
                        <div style="height:200px;margin:0;">
...
<p id="sessionOrigin" style="display:none"><?= $_SESSION['username']; ?></p>
<!-- store username da ga lahko uporabim z jquery-->
