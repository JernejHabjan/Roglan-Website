...
<div id="everything">
    ...
    <div class="headercontainer">
        <div class="container"
             style="margin-left:10%; margin-right:10%; width:80%;padding:0; background-color: #f0fff0;">

            <!--LOGO AND LOGIN-->
            <div class="header-logo">
                <div style="float:left;">
                    <a href="index.php"><img src="logo.png" alt="Roglan" character alt="Logo" newline character
                                             width="100px"/></a>
                </div>
                ...
                <div style="float:left; width:50%;margin-left:20%;">
                    <form id="frmSearch" class="search2" method="get" action="default.html">
                        ...
                        <input class="search2" id="txtSearch" type="text" name="search" placeholder="Search.." size="31"
                               maxlength="255"
                               value=""/>
                ...
                <div class="login">
                    <div class="dropdown">
                        <button class="dropbtn" id="loginButton" onclick="mydropdownFunction('loginDropdown')"
                                style="padding: 10px;background-color:#4d4d4d;">Prijavite se
                        </button>
                        <div class="dropdown-content" id="loginDropdown">
                            <div class="login">
                                ...
                                <br>
                                <button class="dropbtn" onclick="location.href='register.php'" href="register.php">
                                    Registrirajte se
                                </button>
                    ...
                    <div style="display:inline-block">
                        <a class="dropbtn" id="profileButton" onclick="mydropdownFunction('profilQuickShow')"
                           style="padding: 10px;background-color:#4d4d4d">Obišči svoj profil <span class="caret"></span></a>
                        <div class="dropdown-content" id="profilQuickShow">
                            <div>
                                <ul id="navDrop">
                                    Jernej Habjan<br>
                                    neki<br>
                                    <a href="member.php" class="dropbtn" id="profileButton"
                                       style="padding: 10px;background-color:white">Obišči svoj profil</a>
                                    <a href="logout.php" class="dropbtn" id="profileButton"
                                       style="padding: 10px;background-color:grey">logout</a>
                                </ul>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="cart.html" id="cart">
                        <div style="display:inline-block;background-color:#4d4d4d;" class="container minicart"></div>
                    </a>
        ...
        <div class="navbar" style="width:100%; padding:0;border:0;">
            <div id="navBarID" style="margin-left:10%;margin-right:10%;">
                <ul class="topnav" id="myTopnav">
                    ...
                    <li style="float:left;"><a class="dropbtn" onclick="mydropdownFunction('izdelkiDropdown')">Izdelki
                            <span class="caret"></span></a>
                        <div class="dropdown-content" id="izdelkiDropdown"
                    ...
                    <li style="float:left;"><a class="dropbtn" onclick="mydropdownFunction('domaciIzdelkiDropdown')">Domači
                            izdelki <span class="caret"></span></a>
                        <div class="dropdown-content" id="domaciIzdelkiDropdown"
                             style="left:0;margin-left:10%;margin-right:10%;width:80%;">
                            <div style="display:inline-flex;">

                                <ul id="navDrop">
                                    <li style="margin-bottom:20px"><a href="domaciIzdelki.php"><b>Vsi izdelki</b></a>
                                    </li>
                ...
                <div id="leftRightMover">
                    <div class="container" style="padding:0;margin-left:10%;margin-right:10%;">
                        <div id="divContainer">
                            ...
                            <div id="krogec" class="round">
                                <a href="izdelki.php#brinjevec"><img src="slike/smallbrinjevec1l.jpg"
                                                                     height="200px"/></a>
                            </div>
                            <div id="krogec" class="round">
    ...
    <div class="main" id="mainContent">
        ...
        <div id="parent" style="width:100%;">
            <div class="narrow"
                 style="background-color:#1a1a1a;color:white;margin:0;min-width:150px;width:25%;display: inline-flex;">
            ...
            <div class="left-box" style="margin:0;">
                ...
                <div id="parent" style="width:100%;">
                    ...
                    <div class="left-box" style="background-color:#4d4d4d;margin:0;">
                        <p style="color:#f2f2f2">Obrano sadje iz domačih češn... neki tle napišeš kok je use zakon pa
                            hudo itd</p>
                    </div>
        ...
        <div id="parent" style="width:100%;">
            ...
            <div class="left-box" style="margin:0;">
                ...
                <div id="parent" style="width:100%;">
                    ...
                    <div class="left-box" style="background-color:#4d4d4d;margin:0;">
                        <p style="color:#f2f2f2">likerji izdelani iz domačih češn........ neki tle napišeš kok je use
                            zakon pa hudo itd</p>
                    </div>
        ...
        <div style="text-align: center;">
            <div class="dropdown">
                <button id="kontaktirajte" class="dropbtn" style="top: 50%;"><h2 style="text-align:center">KONTAKTIRAJTE
                        NAS</h2></button>
            </div>
            ali...
            ...
            <div class="dropdown">
                <button id="narocite" class="dropbtn" style="top: 50%;"><h2 style="text-align:center">NAROČITE
                        IZDELKE</h2></button>
        ...
        <div class="container1">
            ...
            <div class="content1" id="content1ID">
                ...
                <div class="dropdown-content"
                     style="display:initial;position:relative; background-color:#4d4d4d; box-shadow:none">
                    <div style="display:inline-flex;">
                    ...
                    <div style="display:inline-flex;">
                        <ul style="list-style-type:none;">
                            <li><a href="domaciIzdelki.php" style="margin-bottom:10px"><b>Vsi domači izdelki</b></a>
                            </li>
                            <li><a href="domaciIzdelki.php#marmelade">Marmelade</a></li>
                            <li><a href="domaciIzdelki.php#BrinjeveJagode">Brinjeve jagode</a></li>
                            <li><a href="domaciIzdelki.php#brinjevoOlje">Brinjevo olje</a></li>
                    ...
                    <ul class="footerspan"><strong>follow us on:</strong><br>
                        <li>Facebook GLORIALOOK PAZI<br>
                            ...
                            <iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fwww.facebook.com%2FoGloriaLook%2F&width=150&layout=standard&action=like&show_faces=true&share=true&height=80&appId"
                                    width="200" height="80" style="border:none;overflow:hidden" scrolling="no"
                                    frameborder="0" allowTransparency="true"></iframe>
                        </li>

                        <li>Twitter neki<br>
                            <a href="https://twitter.com/darkneess10" class="twitter-follow-button"
                               data-show-count="false">Follow @darkneess10</a>
                            <script>
                                !function (d, s, id) {
        ...
        <!--   <p id="sessionOrigin" style="display:none"></p> store username da ga lahko uporabim z jquery-->
